...
--variant result/pooled.RGsorted.HaplotypeCaller.all.indel.vcf.gz \
...
--output result/pooled.RGsorted.HaplotypeCaller.all.indel.filtered.vcf.gz \
1>       result/pooled.RGsorted.HaplotypeCaller.all.indel.filtered.vcf.gz.log \
2>       result/pooled.RGsorted.HaplotypeCaller.all.indel.filtered.vcf.gz.err
